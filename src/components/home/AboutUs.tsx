        ...
        <section className="relative mx-auto px-4 2xl:px-0 pt-20 pb-[128px] lg:pb-[224px] w-full max-w-7xl">
            <div className="my-8 lg:my-12">
                ...
                <div className="flex lg:flex-row flex-col justify-end gap-4">
                    <h1 className="max-w-[718px] font-bold text-2xl lg:text-5xl leading-[120%]">We are a non-governmental organization</h1>
                    <div className="max-w-[465px]">
                        <p className="font-bold text-lg lg:text-xl leading-[150%]">Our Mission to Protect Every Child</p>
