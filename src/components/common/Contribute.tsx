...
export default function Contribute() {
    return (
        <section className="mx-auto mb-20 w-full max-w-[1280px] h-[384px]">
            <div className="relative rounded-3xl w-full h-full">
                ...
                <div className="z-20 absolute flex flex-col justify-center items-center gap-8 rounded-3xl w-full h-full">
                    <p className="mx-auto w-full max-w-[805px] font-bold text-white text-4xl text-center leading-[120%]">Together, we can create a world where every child is safe, supported, and free to thrive.</p>
