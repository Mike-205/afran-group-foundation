            ...
            <div className="flex lg:flex-row flex-col items-center w-full">
                <div className="my-8 lg:my-12 w-full max-w-[704px]">
                    ...
                    <div className="flex flex-col justify-end gap-4 ml-8 md:ml-[88px]">
                        <h1 className="max-w-[461px] font-bold lg:text-[56px] text-2xl md:text-4xl leading-[120%]">Resources & Support</h1>
                        <div className="space-y-4 md:mt-6">
                            <p className="text-sm lg:text-base leading-[160%]">Essential tools, guides, and support materials for survivors, families, and professionals</p>
                        </div>
                    </div>
                </div>
