...
export default function ContactUs() {
    return (
        <section className="bg-primary-500 mx-auto px-4 2xl:px-0 w-full max-w-[120rem] h-[420px] text-white">
            <div className="relative rounded-3xl w-full h-full">
                <div className="z-20 absolute flex flex-col justify-center items-center gap-8 rounded-3xl w-full h-full">
                    ...
                    <p className="mx-auto px-4 lg:px-0 w-full max-w-[805px] text-gray-100 text-xl lg:text-2xl text-center leading-[120%]">Can&lsquo;t find what you&lsquo;re looking for? Our team is here to help you access the resources you need.</p>
