export const projects: { title: string; description: string; image: string }[] = [
    {
        title: "Helpline & Rapid Response",
        description: "A 24/7 helpline with rapid response teams offering immediate intervention, safe referrals, medical care, and legal support for children at risk.",
